...
describe('SpeciesDetailsComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [],
      imports: [HttpClientTestingModule, SpeciesDetailsComponent, StoreModule.forRoot({})],
      providers: [
  ...
  it('should fetch species details when data is not available', () => {
    ...
    expect(storeSpy.dispatch).toHaveBeenCalledWith(AppApiActions.displaySpeciesDetails({ species: mockData }));
  });
  ...
  it('should save visit and fetch homeworld details when species details are available', () => {
    ...
    spyOn(httpSpy, 'get').and.returnValue(of({
      name: "Tatooine",
      rotation_period: "23",
      orbital_period: "304",
      diameter: "10465",
